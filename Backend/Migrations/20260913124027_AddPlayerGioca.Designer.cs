...
namespace CalcioAcinque.Backend.Migrations
{
    ...
    [Migration("20260913124027_AddPlayerGioca")]
    partial class AddPlayerGioca
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CalcioAcinque.Backend.Models.Entities.MatchChoreAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MatchId", "ChoreId")
                        .IsUnique();

                    b.ToTable("match_chore_assignments");
                });

            modelBuilder.Entity("CalcioAcinque.Backend.Models.Entities.MatchVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MatchId", "VoterPlayerId")
                        .IsUnique();

                    b.ToTable("match_votes");
                });
            ...
            modelBuilder.Entity("CalcioAcinque.Backend.Models.Entities.TeamChore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CalcioAcinque.Backend.Models.Entities.TeamExpense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CalcioAcinque.Backend.Models.Entities.MatchChoreAssignment", b =>
                {
                    b.HasOne("CalcioAcinque.Backend.Models.Entities.TeamChore", "Chore")
            ...
            modelBuilder.Entity("CalcioAcinque.Backend.Models.Entities.MatchVote", b =>
                {
                    ...
                    b.HasOne("CalcioAcinque.Backend.Models.Entities.Player", "Voted")
                        .WithMany()
                        .HasForeignKey("VotedPlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CalcioAcinque.Backend.Models.Entities.Player", "Voter")
                        .WithMany()
